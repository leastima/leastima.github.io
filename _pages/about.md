...
Generally, I'm curious about what phenomenon is common across different kinds of models, why these phenomenon happen and how I can affect them in various ways. Specifically, my current research focuses on **Scientific Machine Learning (SciML)** — specifically understanding the loss landscape geometry and training dynamics of physics-informed. 

Previously, I received my B.E. in Data Science and Big Data Technology from **Tongji University** (2019–2023). Then, I worked as a Software Development Engineer at **Beijing Dajia Internet Information Technology (Kuaishou)** (2023–2025), where I built performance analysis tools and maintain JS container for large-scale mobile systems. I have also worked as an intern mentored by [Prof. Yaoqing Yang](https://web.cs.dartmouth.edu/people/yaoqing-yang) and [Pu Ren](https://paulpuren.github.io/), and we just finished the first paper in my life.
